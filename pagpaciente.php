...
// Convertir el valor a cadena (por si acaso)
$encryptedEmailStr = strval($encryptedEmail);
...
try {
      ...
      curl_setopt($ch, CURLOPT_HTTPGET, true); //esta la parte del get 
...
//----------------------------------------------------------------
   ...
   // Obtiene los datos
$documentos2 = $collection2->findOne(['8_email' => $encryptedEmailStr]);//Muestra un solo paciente$aes->decrypt($variable1)
$documentos = $collection->findOne(['2_Id_Pac' =>  $documentos2['1_Id_Pac']]);//Muestra un solo paciente
...
<h2 style="text-align: center;">HISTORIA CLÍNICA Nro.  <?php echo $documentos['1_Id_HC']; ?></h2>
<br>
<div class="container">
...
<!-- /.row -->
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Fname" name="Fname" placeholder="Nombre de paciente" value="<?php echo  $aes->decrypt($documentos2['2_nombre_paciente']); ?>" disabled required>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="FHM" name="FHM" placeholder="Codigo de Hístoria" value="<?php echo  ($aes->decrypt($documentos['3_historial_med'])  ?? 'N/A');?>"  disabled required>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="FM" name="FM" placeholder="Medicacion" value="<?php echo  ($aes->decrypt($documentos['4_medicacion'])  ?? 'N/A');?>" disabled required>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Faler" name="Faler" placeholder="Alergias" value="<?php echo  ($aes->decrypt($documentos['5_alergia'])  ?? 'N/A');?>" disabled required>
      </div>
    </div>
