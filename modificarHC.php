...
<div class="container">
<form id="formulario" action="php/modHC.php?var1=<?php echo  ($documentos['1_Id_HC']  ?? 'N/A');?>&var2=<?php echo  ($documentos['2_Id_Pac']  ?? 'N/A');?>
" method="POST" enctype="multipart/form-data">
    ...
    <div class="row" style="display: none;">
      ...
      <div class="col-75">
        <input  type="text" id="Fhistori" name="Fhistori" placeholder="Codigo de Hístoria" value="<?php echo  ($documentos['1_Id_HC']  ?? 'N/A');?>" required>
      </div>
    </div>
    ...
    <div class="row" style="display: none;">
      ...
      <div class="col-75">
        <input type="text" id="Fpaci" name="Fpaci" placeholder="Codigo de Hístoria" value="<?php echo  ($documentos['2_Id_Pac']  ?? 'N/A');?>" required>
      </div>
    </div>
<!-- /.row -->
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Fname" name="Fname" placeholder="Nombre de paciente" value="<?php echo  ($aes->decrypt($documentos2['2_nombre_paciente'])  ?? 'N/A');?>" required>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Fced" name="Fced" placeholder="Cedula de paciente" value="<?php echo  ($aes->decrypt($documentos2['3_cedula'])  ?? 'N/A');?>" required>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Fnaci" name="Fnaci" placeholder="Fecha de nacimiento del paciente" value="<?php echo  ($aes->decrypt($documentos2['4_fecha_nacimiento'])  ?? 'N/A');?>" required>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Fgene" name="Fgene" placeholder="Genero del paciente" value="<?php echo  ($aes->decrypt($documentos2['5_genero'])  ?? 'N/A');?>" required>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Fcelu" name="Fcelu" placeholder="Número célular del paciente" value="<?php echo  ($aes->decrypt($documentos2['6_celular'])  ?? 'N/A');?>" required>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Fdire" name="Fdire" placeholder="Dirección del paciente" value="<?php echo  ($aes->decrypt($documentos2['7_direccion'])  ?? 'N/A');?>" required>
      </div>
    </div> 
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Fmail" name="Fmail" placeholder="Email del paciente" value="<?php echo  ($aes->decrypt($documentos2['8_email'])  ?? 'N/A');?>" required>
      </div>
    </div>    
...
<!--  end /.row -->
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="FIngreso" name="FIngreso" placeholder="fecha del Ultimo Ingreso" value="<?php echo  ($documentos['6_ultimo_ingreso']  ?? 'N/A');?>" required>
      </div>
    </div>
